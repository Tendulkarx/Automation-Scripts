...
HEADERS = {
    "User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 11_2_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.61 Safari/537.36",
    ...
    if products_below_limit:
        ...
        for title, price, url in products_below_limit:
            ...
            message += """\
              ...
              """.format(
                title=" ".join(title.split()[:15]), price=price, url=url
            )
